...
export default function Plan() {
    ...
    const [coiffeur, setCoiffeur] = useState("Nadir")
    const [coiffeurPlan, setCoiffeurPlan] = useState("Nadir")
    ...
    if (coiffeurPlan != "all") {
        selectedDayMeetings =
            meetings.filter((meeting) =>
                isSameDay(parseISO(meeting.date), selectedDay) && meeting.coiffeur === coiffeurPlan
            )
        CoiffeurTable = 
    ...
    if (coiffeurPlan == "Nadir") {
        ...
        PlanTable = 
            <div className='grid grid-rows-25 col-start-3 col-end-13 h-full'>
                {selectedDayMeetings.length > 0 ? (
                    selectedDayMeetings.map((meet) => (
                    ...
                    <section className="mt-12 md:mt-0 md:pl-14 h-fit">
                        ...
                        <ol className=" space-y-1 text-sm leading-6 text-gray-500">
                            <div className='grid grid-cols-12 pt-5'>
                                <div className='grid grid-rows-25 col-start-1 col-end-3 h-full'>
                                    {mornings.map((morning, idx) => (
